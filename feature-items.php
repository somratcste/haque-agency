<?php 
			...
			$statement = $db->prepare("SELECT * FROM table_products ORDER BY p_id DESC");
			$statement->execute();
			...
			$statement = $db->prepare("SELECT * FROM table_products ORDER BY p_id DESC LIMIT $start, $limit");
			$statement->execute();
